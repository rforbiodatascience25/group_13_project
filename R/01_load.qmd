...
dir.create(here("data/dirty"), showWarnings = FALSE)

readr::write_csv(dirty_df_meta,
                 here("data/dirty/neurotransmitter-receptors-dirty-meta.csv"))

readr::write_csv(dirty_df_feature,
                 here("data/dirty/neurotransmitter-receptors-dirty-features.csv"))
