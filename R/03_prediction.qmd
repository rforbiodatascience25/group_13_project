...
defining two classes. Based on Knlowedge provided by Ákos, we will spit the receptors into 3 classes: Glutamate, Cys-loop and Other receptors (which includes 2 ionotropic receptors not part of the other 2 superfamilies). It would be interesting to see if we can predict the class from AA composition. To do this we first add a new column to the meta_df called "class".
